...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ResponceStructure<String>> handleCustomerNotFound(CustomerNotFoundException ex) {
	...
	public ResponseEntity<ResponceStructure<String>> handleRestaurantNotFound(RestaurantNotFoundException ex) {
	...
	public ResponseEntity<ResponceStructure<String>> handleItemNotFound(ItemNotFoundException ex) {
	...
	public ResponseEntity<ResponceStructure<String>> handleOrderNotFound(OrderNotFoundException ex) {
	...
	public ResponseEntity<ResponceStructure<String>> handleCartEmpty(CartEmptyException ex) {
	...
	public ResponseEntity<ResponceStructure<String>> handleGenericException(Exception ex) {
	...
	public Map<String, String> handleMethodArgumantNotValid(MethodArgumentNotValidException e) {
